    ...
    <header id="header">
        <nav class="navbar navbar-expand-md">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse contenedor-t" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="cemento.php">Productos
                                de cemento</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="../../neoSolaris/páginas/herramientas.php">Productos Ferreteros</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="../../neoSolaris/páginas/electrico.php">Eléctrico</a></li>
                            </ul>
                        </li>
